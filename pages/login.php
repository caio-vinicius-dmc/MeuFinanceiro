        ...
        <div class="row g-0 h-100">
            ...
            <div class="col-lg-7 d-none d-lg-block login-image-side">
                <div class="login-branding-overlay">
                    <img src="<?php echo base_url('assets/img/logo.png'); ?>" alt="Logo FlowCorp" style="max-width: 200px; filter: drop-shadow(0 0 10px rgba(0,0,0,0.5));">
                    <h1 class="text-white mt-3 display-4 fw-bold">FlowCorp</h1>
                ...
                <div class="login-card p-4 p-md-5">
                    <div class="w-100">
                        ...
                        <div class="text-center mb-4 d-lg-none"> 
                            ...
                            <h3 class="fw-bold mt-2 text-primary">FlowCorp</h3>
                        </div>
