...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03/11/2025 às 22:02
...
INSERT INTO `lancamentos` (`id`, `id_empresa`, `descricao`, `valor`, `tipo`, `data_vencimento`, `data_competencia`, `data_pagamento`, `status`, `anexo_path`, `metodo_pagamento`, `id_forma_pagamento`) VALUES
(3, 3, 'Mesa nova', 500.00, 'despesa', '2025-10-30', '0000-00-00', NULL, 'pendente', NULL, 'Boleto Bancário', 2),
(4, 4, 'Banner novo da fachada', 1500.00, 'despesa', '2025-10-31', '0000-00-00', '2025-11-03', 'pago', NULL, 'PIX', 1),
(5, 5, 'Balcão checkout', 850.00, 'despesa', '2025-10-30', '0000-00-00', '2025-11-03', 'pago', NULL, 'Boleto Bancário', 2),
(6, 5, 'pneus de carro', 1500.00, 'despesa', '2025-10-31', '0000-00-00', '2025-11-03', 'pago', NULL, 'PIX', 1),
(7, 3, 'Compra de agua', 3.00, 'despesa', '2025-11-03', '2025-11-03', '2025-11-03', 'pago', NULL, 'PIX', 1),
(9, 3, 'dasd asdas d', 500.00, 'despesa', '2025-11-03', '0000-00-00', '2025-11-03', 'pago', NULL, 'PIX', 1);
